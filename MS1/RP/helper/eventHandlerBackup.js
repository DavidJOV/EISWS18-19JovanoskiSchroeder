            ...
            getCrew(krankmeldung)
                .then(function sendMSG(crew) {
                    ...
                    for (var i = 0; i < crew.length; i++) {
                        ...
                        let personalLink = "localhost:3000/krankmeldungen/ersatz/" + krankmeldungID[0].id + "/?mitarbeiter=" + encoder.encode(crew[i].id.toString()) + "&station=" + encoder.encode(crew[i].stationID.toString());
