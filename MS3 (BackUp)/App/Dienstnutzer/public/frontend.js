...
function speichereMitarbeiter(mitarbeiter) {
  ...
  xmlhttp.open("POST", "sistershift.ddns.net/mitarbeiter");
  ...
  xmlhttp.onload = function() {
    ...
    if (jsonResponse == 201) {
      window.location.href = "dienstplanung.herokuapp.com/bestaetigung"
    } else {
      window.location.href = "dienstplanung.herokuapp.com/entschuldigung"
    }
  }
}
...
function speichereWunsch(wunsch) {
  ...
  xmlhttp.open("POST", "sistershift.ddns.net/mitarbeiter/wuensche");
  xmlhttp.setRequestHeader("Content-Type", "application/json");
...
function erstelleDienstplan(dienstplan) {
  ...
  var xmlhttp = new XMLHttpRequest(); // new HttpRequest instance
  xmlhttp.open("POST", "sistershift.ddns.net/dienstplaene");
  xmlhttp.setRequestHeader("Content-Type", "application/json");
...
function speichereAbwesenheit(abwesenheit) {
  ...
  var xmlhttp = new XMLHttpRequest(); // new HttpRequest instance
  xmlhttp.open("POST", "dienstplanung.herokuapp.com/abwesenheiten");
  xmlhttp.setRequestHeader("Content-Type", "application/json");
...
function trageErsatzEin(id) {
  ...
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.open("POST", "sistershift.ddns.net/mitarbeiter/" + mitarbeiterID + "/ersatzeintragungen");
  xmlhttp.setRequestHeader("Content-Type", "application/json");
  ...
  xmlhttp.onload = function() {
    ...
    console.log(jsonResponse)
    if (jsonResponse == 201) {
      window.location.href = "dienstplanung.herokuapp.com/mitarbeiter/" + mitarbeiterID + "/ersatzeintragungen"
    } else {
      window.location.href = "dienstplanung.herokuapp.com/entschuldigung"
    }
  }
...
function loescheErsatzAnfrage(id) {
  ...
  // HTTP Request an Dienstnutzer
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.open("DELETE", "sistershift.ddns.net/mitarbeiter/" + mitarbeiterID + "/ersatzeintragungen");
  xmlhttp.setRequestHeader("Content-Type", "application/json");
  ...
  xmlhttp.onload = function() {
    ...
    console.log(jsonResponse)
    if (jsonResponse == 204) {
      window.location.href = "dienstplanung.herokuapp.com/mitarbeiter/" + mitarbeiterID + "/ersatzanfragen"
    } else {
      window.location.href = "dienstplanung.herokuapp.com/entschuldigung"
    }
  }
...
function geheZuErsatzanfragen(element) {
  ...
  window.location.href = "dienstplanung.herokuapp.com/mitarbeiter/" + index + "/ersatzanfragen";
}

function geheZuErsatzeintragung(element) {
  console.log(element)
  var index = element[0].value;
  window.location.href = "dienstplanung.herokuapp.com/mitarbeiter/" + index + "/ersatzeintragungen";
}
...
function getDienstplanBydate(datum) {
  ...
  window.location.href = "dienstplanung.herokuapp.com/dienstplan?monat=" + dienstplanDatum.monat + "&jahr=" + dienstplanDatum.jahr
